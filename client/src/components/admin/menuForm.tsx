...
import { MenuForm, MenuItem } from "../../types/menu";
import { createMenu } from "../../apiService/adminApis";
...
export const MenuCreate = () => {
  ...
  const generateId = () => `item_${Date.now()}_${Math.random().toString(36).slice(2)}`;
      ...
      <main>
        {submitted ? (
          <div className="success-screen">
            ...
            <h2>MENU CREATED</h2>
            <p>
              <strong>"{form.name}"</strong> has been saved
              {form.items.length > 0 &&
                ` with ${form.items.length} item${form.items.length > 1 ? "s" : ""}`}.
            </p>
            ...
            {activeTab === "menu" && (
              <div className="card">
                ...
                <div className="field required">
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Appetizers, Salads, Sides..."
                    value={form.category}
